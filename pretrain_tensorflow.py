...
from model_tensorflow import  BertModel
from dataset_tensorflow import Graph_Bert_Dataset
import time
import os
...
train_dataset, test_dataset = Graph_Bert_Dataset(path='data/USPTO-50k_no_rxn/src-train.txt',smiles_field='CAN_SMILES',addH=addH).get_data()
...
for epoch in range(10):
    ...
    for (batch, (x, y, char_weight)) in enumerate(train_dataset):
        train_step(x, None, y, char_weight)
